...
public class RegisterUser_locator {
	
	public static By CreateAnAccountText = By.xpath("//div[@id='noSlide']/h1[contains(text(),'Create an account')]");
	public static By maleGenderRadioBtn = By.id("id_gender1");
	public static By userFirstName = By.id("customer_firstname");
	public static By userLastName = By.id("customer_lastname");
	public static By userPassword = By.id("passwd");
	public static By userBirthDay = By.id("days");
	public static By userBirthMonth = By.id("months");
	public static By userBirthYear = By.id("years");
